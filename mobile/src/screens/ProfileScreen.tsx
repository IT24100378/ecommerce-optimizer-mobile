		...
		return (
			<SafeAreaView style={styles.container}>
				...
				<View style={styles.formCard}>
					...
					{mode === 'signup' ? (
						<>
							<TextInput value={form.confirmPassword} onChangeText={(value) => setForm((prev) => ({ ...prev, confirmPassword: value }))} placeholder="Re Enter Password" placeholderTextColor="#94a3b8" style={styles.input} secureTextEntry />
